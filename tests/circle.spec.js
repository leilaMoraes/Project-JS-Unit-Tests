...
/*
 ...
 describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio 3, a função `circle` retorna um objeto contendo os valores esperados', () => {
    expect(circle(3)).toEqual({radius: 3, area: 28.259999999999998, circumference: 18.84});
  });
  
  it('Verifica se a função `circle` retorna `undefined` quando recebe valores que não sejam números', () => {
  ...
  it('Verifica se a função `circle` retorna uma `key` com `value` igual à area correta para um círculo de raio 3', () => {
